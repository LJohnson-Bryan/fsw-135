            ...
            <nav className="bg-indigo-600">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between h-16">
                        <div className="flex items-center">
                            ...
                            <div className="hidden md:block">
                                <div className="ml-10 flex items-baseline space-x-4">
                                    <Link to="/issues" className={location.pathname === "/issues" ? "bg-indigo-700 text-white px-3 py-2 rounded-md text-sm font-medium" : "text-white hover:bg-indigo-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium"}>Issues</Link>
                                    <Link to="/create" className={location.pathname === "/create" ? "bg-indigo-700 text-white px-3 py-2 rounded-md text-sm font-medium" : "text-white hover:bg-indigo-500 hover:bg-opacity-75 px-3 py-2 rounded-md text-sm font-medium"}>Create Issue</Link>
                                </div>
                            </div>
                        </div>
                        <div className="hidden md:block">
                            <div className="ml-4 flex items-center md:ml-6">
                                <h3 className="text-white text-md">John doe</h3>
                                ...
                                <div className="ml-3 relative">
                                    <div>
                                        <button onClick={() => setProfileDropDown(!profileDropDown)} className="max-w-xs bg-indigo-600 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white" id="user-menu" aria-haspopup="true">
                                            ...
                                            <img className="h-8 w-8 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=NoqdqpxjtB&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                                        </button>
                                    </div>
                                    ...
                                    <div className={`${profileDropDown ? 'transition ease-out duration-100 transform opacity-100 scale-100' : 'ransition ease-in duration-75 transform opacity-0 scale-95'} origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5`} role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                                        ...
                                        <Link to="/" onClick={() => setProfileDropDown(false)} className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100" role="menuitem">Sign Out</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        {/* <!-- Mobile menu button --> */}
                            <button onClick={() => setNavToggle(!navToggle)} className="bg-indigo-600 inline-flex items-center justify-center p-2 rounded-md text-indigo-200 hover:text-white hover:bg-indigo-500 hover:bg-opacity-75 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-600 focus:ring-white">
                    ...
                    <div className="pt-4 pb-3 border-t border-indigo-700">
                        <div className="flex items-center px-5">
                            <div className="flex-shrink-0">
                                <img className="h-10 w-10 rounded-full" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=NoqdqpxjtB&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" />
                            </div>
                            <div className="ml-3">
                        ...
                        <div className="mt-3 px-2 space-y-1">
                            ...
                            <Link to="/" onClick={() => setNavToggle(false)} className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-indigo-500 hover:bg-opacity-75">Sign Out</Link>
                        </div>
                    </div>
                </div>
            </nav>
