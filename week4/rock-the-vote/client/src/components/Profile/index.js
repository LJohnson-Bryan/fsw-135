...
const Profile = props => {
    ...
    const [userData, setUserData] = useState({username: "John Doe", profileImg: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixqx=NoqdqpxjtB&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80"})
        ...
        <div>
            <div className="flex items-center mb-5">
                ...
                <form onSubmit={submitChanges}>
                    ...
                    <input type="text" name="name" id="name" class="border-gray-300 shadow-sm focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm rounded-md ml-3" onChange={e => setUserData({...userData, username: e.target.value})} value={userData.username} placeholder="Your Name" />
                </form>
                : 
